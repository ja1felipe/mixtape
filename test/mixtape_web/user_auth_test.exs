defmodule MixtapeWeb.UserAuthTest do
  use MixtapeWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Mixtape.Users
  alias MixtapeWeb.UserAuth
  import Mixtape.UsersFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MixtapeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MixtapeWeb.Endpoint.subscribe(live_socket_id)
